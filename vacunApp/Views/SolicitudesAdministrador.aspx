<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/SolicitudesAdministrador.aspx.cs" Inherits="Views_SolicitudAdmin" %>
...
<head runat="server">
    ...
    <title>Solicitudes || VacunApp</title>
</head>
<body>
        ...
        <div class="divtabla">
            <asp:GridView ID="tabla" runat="server" AutoGenerateColumns="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField HeaderText="Ver" Text="Click" DataNavigateUrlFields="usuarioId"
