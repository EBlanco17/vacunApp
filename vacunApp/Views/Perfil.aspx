<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Controller/Perfil.aspx.cs" Inherits="Views_Perfil" %>
...
<body>
    ...
    <form runat="server">
        ...
        <div class="profilebox">
            ...
            <asp:TextBox runat="server" CssClass="txtNaci" ID="txtNac" placeholder="DD/MM/AAAA" />
